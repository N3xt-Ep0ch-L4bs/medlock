      ...
      <div style={{ 
        ...
        <div style={{ textAlign: "center", marginBottom: "2rem" }}>
          ...
          <p style={{ color: "#6b7280", fontSize: "1rem" }}>
            Your wallet is not registered as a doctor
          </p>
        </div>
        ...
        <div style={{ 
          ...
          <p style={{ 
            ...
            To access the doctor dashboard, you need to be registered by an authorized organization. 
          ...
          <div style={{ 
            ...
            <ul style={{ 
              ...
              <li>Once registered, you'll be able to access the doctor dashboard</li>
            </ul>
          </div>
        </div>
