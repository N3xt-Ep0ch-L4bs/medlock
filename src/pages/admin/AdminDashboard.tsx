...
import { ArrowLeft, ArrowRight, Check, User, Briefcase, FileCheck, Building2, Pill } from "lucide-react";
...
const AdminDashboard = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      const ownerAddress = activeTab === "doctor" 
      ...
      console.log(`Encrypting and saving ${activeTab} profile to Walrus...`);
      ...
      console.log(`Calling register_${activeTab} smart contract...`);
      const result = await signAndExecuteTransaction({
        transaction: tx,
      });

      console.log(`${activeTab === "doctor" ? "Doctor" : "Pharmacy"} registered successfully:`, result.digest);
      ...
      console.error(`Error registering ${activeTab}:`, error);
      alert(
        `Failed to register ${activeTab}: ${
  ...
  const handleTabChange = (tab: "doctor" | "pharmacy") => {
    setActiveTab(tab);
    setCurrentStep(1);
    setSubmitSuccess(false);
    setDoctorErrors({});
        ...
        <div className="form-grid">
          <div className="form-group full-width">
            ...
            <small style={{ color: "#6b7280", fontSize: "0.875rem", marginTop: "0.25rem", display: "block" }}>
              This field is automatically filled with your organization name
            </small>
          </div>
  ...
  return (
    <div className="admin-dashboard">
      <div className="admin-header">
        ...
        <h1>Register {activeTab === "doctor" ? "Doctor" : "Pharmacy"}</h1>
      </div>
      ...
      <div className="admin-content">
        ...
        <div className="admin-tabs">
          ...
          <button
            className={`admin-tab ${activeTab === "pharmacy" ? "active" : ""}`}
        ...
        <div className="form-container">
          {submitSuccess ? (
            <div className="success-message">
              ...
              <h2>{activeTab === "doctor" ? "Doctor" : "Pharmacy"} Profile Created Successfully!</h2>
              <p>The {activeTab === "doctor" ? "doctor" : "pharmacy"} has been added to your organization.</p>
            </div>
          ) : (
            <>
              {activeTab === "doctor" && (
